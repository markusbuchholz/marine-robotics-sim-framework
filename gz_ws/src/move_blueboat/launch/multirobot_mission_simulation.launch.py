...
def generate_launch_description():
    return LaunchDescription([
        ...
        ExecuteProcess(
            cmd=['env', 'LIBGL_ALWAYS_SOFTWARE=1', 'gz', 'sim', 'waves_asv_tether_auv_mission_3.sdf'], 
           # cmd=['env', 'LIBGL_ALWAYS_SOFTWARE=1', 'gz', 'sim', 'waves_asv_tether_auv_mission_5.sdf'], 
           # cmd=['env', 'LIBGL_ALWAYS_SOFTWARE=1', 'gz', 'sim', 'waves_asv_tether_auv_mission_10.sdf'], 
            output='screen'
        ),
